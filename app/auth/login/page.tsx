    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-slate-950">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 shadow-2xl">
          ...
          <p className="text-slate-400 text-sm mb-8">Sign in to continue your conversations</p>
          ...
          <div className="mt-6 pt-5 border-t border-slate-800/80 text-center space-y-2">
            ...
            <p className="text-xs text-slate-500">
              ...
              <Link href="/admin/login" className="text-rose-400 hover:text-rose-300 font-medium transition-colors">
                Admin Panel Login →
              </Link>
            </p>
          </div>
